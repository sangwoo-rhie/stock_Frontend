const getOneChallengePort = '52.79.115.32:3000';
  ...
  await axios
    ...
    .then((response) => {
      ...
      const profileImage = challenge.userImageUrl
        ? `http://Stock Project.s3.amazonaws.com/${challenge.userImageUrl}`
      ...
      challengerList.innerHTML += response.data.data
        .map((challenger) => {
          const profileImage = challenger.user.imgUrl
            ? `http://Stock Project.s3.amazonaws.com/${challenger.user.imgUrl}`
            : `assets/img/avatar/avatar-1.png`;
      ...
      <div class="card-body">
        <div id=${friend.id}>
          <img class="rounded-circle" src=${
            friend.imgUrl
              ? `http://Stock Project.s3.amazonaws.com/${friend.imgUrl}`
              : 'assets/img/avatar/avatar-1.png'
